      ...
      <>
        <section className='max-w-4xl mx-auto px-2 mt-8'>
          <h1 className='text-2xl font-bold text-center relative'>
            ...
            <img src='/images/experiencias/lines_arrow.png' alt='' className='hidden md:flex absolute top-1/2 w-[80%] left-1/2 -translate-x-1/2' />
          </h1>

          <div className='mt-4 flex flex-col md:flex-row md:mt-16 gap-4 px-8 items-center'>
            <div>
