        ...
        <div className='grid gap-4 md:grid-cols-3'>
          <div className='border border-grayDark rounded-md bg-grayLight/50 backdrop-blur p-4'>
            ...
            <div className='h-20 flex items-center'>
              <NextImage src='/images/experiencias/d1-1.png' alt='' className='mx-auto w-32 mb-4' />
            </div>
          ...
          <div className='border border-grayDark rounded-md bg-grayLight/50 backdrop-blur p-4'>
            ...
            <div className='h-20 flex items-center'>
              <NextImage src='/images/experiencias/d1-2.png' alt='' className='mx-auto w-32 mb-4' />
            </div>
          ...
          <div className='border border-grayDark rounded-md bg-grayLight/50 backdrop-blur p-4'>
            ...
            <div className='h-20 flex items-center'>
              <NextImage src='/images/experiencias/d1-3.png' alt='' className='mx-auto w-32 mb-4' />
            </div>
