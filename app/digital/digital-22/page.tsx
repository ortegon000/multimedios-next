...
export const metadata: Metadata = {
  title: 'Multimedios - Digital 22',
  description: 'Presentación multimedios'
}

const images = [
  '/images/digital/d22-1.png',
  '/images/digital/d22-2.png',
  '/images/digital/d22-3.png'
]
const logo = '/images/digital/d22.png'
const title = ''
  ...
  return (
    <ContentLayout section='digital'>
      <>
        ...
        <CardBgBlur>
          <Component15 images={images} logo={logo} title={title} leftLogo logoHeight='w-32' />
        </CardBgBlur>
      </>
    </ContentLayout>
  )
