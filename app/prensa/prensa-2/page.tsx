      ...
      <section className='max-w-5xl mx-auto px-2 mt-4'>
        ...
        <div className='md:flex mt-4 gap-4'>
          <div className='mb-4 md:mb-0 md:w-1/3'>
            <img src='/images/prensa/d3-1.png' alt='' className='hover:scale-110 w-[80%] md:w-[95%] mx-auto transition-transform hover:-rotate-12' />
          </div>
          ...
          <div className='mb-4 md:w-1/3'>
            ...
            <div className='w-full bg-grayDark rounded-md p-4 text-grayLight relative pt-12 md:pt-4 md:pl-12'>
              <img src='/images/prensa/d3-2.png' alt='' className='w-20 absolute -translate-y-1/2 md:-translate-y-0 md:-translate-x-1/2 m-auto right-0 top-0 md:bottom-0 left-0 md:right-[unset]' />
              <p>
